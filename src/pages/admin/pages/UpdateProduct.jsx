    ...
    return (
        <div>
            <div className=' flex justify-center items-center h-screen bg-dark-bg'>
                <div className=' bg-gray-800 border border-amber-200 px-10 py-5 rounded-xl '>
                    <div className="">
                        <h1 className='text-center text-amber-500 text-xl mb-4 font-bold'>Update Product</h1>
                    </div>
                    <div>
                        <input type="text"
