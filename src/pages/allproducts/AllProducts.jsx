...
function AllProducts() {
    ...
    return (
        <section className="bg-dark-bg body-font">
            <div className="container px-5 py-8 md:py-16 mx-auto">
                <div class="lg:w-1/2 w-full mb-6 lg:mb-10">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-white">All Games</h1>
                            ...
                            return (
                                <div onClick={() => window.location.href = `/productinfo/${id}`}
                                    ...
                                    <div className="h-full bg-gray-800 border-2 hover:shadow-amber-100 hover:shadow-2xl transition-shadow duration-300 ease-in-out border-amber-200 border-opacity-60 rounded-2xl overflow-hidden" >
                                        ...
                                        <div className="p-5 border-t-2 text-white">
                                            <h2 className="tracking-widest text-xs title-font font-medium  mb-1" >Level Up</h2>
                                            <h1 className="title-font text-lg font-medium  mb-3" >{title}</h1>
                                            <p className="leading-relaxed mb-3 " >₹ {price}</p>
                                            <div className=" flex justify-center">
                                                <button type="button"
                                                    onClick={() => addCart(item)}
                                                    className="focus:outline-none bg-amber-600 hover:bg-amber-700 rounded-lg text-sm w-full  py-2">Add To Cart</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
