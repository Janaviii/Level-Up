...
function Cart() {
  ...
  return (
    <Layout >
      <div className="h-screen bg-dark-bg pt-5 mb-[60%] text-white" >
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          <div className="rounded-lg md:w-2/3 ">
            {cartItems.map((item, index) => {
              ...
              return (
                <div className="justify-between mb-6 rounded-lg border border-amber-200 drop-shadow-xl bg-gray-800 p-6  sm:flex  sm:justify-start" >
                  <img src={imageUrl} alt="product-image" className="w-full rounded-lg sm:w-40" />
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    <div className="mt-5 sm:mt-0">
                      <h2 className="text-lg font-bold "  >{title}</h2>
                      <h2 className="text-sm  "  >{description}</h2>
                      <p className="mt-1 text-lg font-semibold text-amber-400"  >₹{price}</p>
                    </div>
          ...
          <div className="mt-6 h-full text-white rounded-lg border border-amber-400 bg-gray-800 p-6 shadow-md md:mt-0 md:w-1/3" >
            ...
            <hr className="my-4" />
            <div className="flex justify-between mb-3 text-amber-400">
